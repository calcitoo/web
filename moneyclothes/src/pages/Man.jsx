...
function Man() {
  return (
    <div style={{ padding: '100px 40px', backgroundColor: 'transparent', minHeight: '100vh' }}>
      <h1 style={{ letterSpacing: '4px', textTransform: 'uppercase', marginBottom: '40px' }}>MAN</h1>
      
      <div style={{ display: 'flex', gap: '20px', maxWidth: '400px' }}>
        <div>
          <img src={man} style={{ width: '100%', objectFit: 'cover' }} />
          <p style={{ letterSpacing: '2px', textTransform: 'uppercase', marginTop: '10px' }}>Bolan Pant</p>
